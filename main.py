...
jumpy_fx = pygame.mixer.Sound('assets/jump.mp3')
jumpy_fx.set_volume(1)
...
#define font
font_small = pygame.font.SysFont('arial.tff', 20)
font_big = pygame.font.SysFont('arial.tff', 30)


#load images
jumpy_image = pygame.image.load('assets/idealgood.png').convert_alpha()
bg_image = pygame.image.load('assets/bg.png').convert_alpha()
platform_image = pygame.image.load('assets/pad.png').convert_alpha()
#bird spritesheet
...
#function for drawing score panel
def draw_panel():
...
class Player():
	...
	def move(self):
		...
		#ensure player doesnt go off the dge of the screen
...
class Platform(pygame.sprite.Sprite):
	...
	def update(self, scroll):
		...
		#update platforms vertical postion
		self.rect.y += scroll
...
while run:
	...
	if game_over == False:
		...
		#draw line at prev high score
		pygame.draw.line(screen, WHITE, (0, score - high_score + SCROLL_THRESH),(SCREEN_WIDTH, score - high_score + SCROLL_THRESH), 3)
		draw_text('HIGH SCORE', font_big, WHITE, SCREEN_WIDTH - 130, score - high_score + SCROLL_THRESH)
		...
		if pygame.sprite.spritecollide(jumpy, enemy_group, False):
			...
			if fade_counter < SCREEN_WIDTH:
				...
				draw_text('GAME OVER!', font_big, WHITE, 135, 200)
				draw_text('SCORE: ' + str(score), font_big, WHITE, 146, 250)
				draw_text('PRESS SPACE TO PLAY AGAIN', font_big, WHITE, 57, 300)
				#update high score
				if score > high_score:
					high_score = score
